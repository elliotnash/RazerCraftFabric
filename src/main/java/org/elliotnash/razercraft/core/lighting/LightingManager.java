package org.elliotnash.razercraft.core.lighting;
...
public class LightingManager {
  ...
  public LightingManager(DBusConnection connection, String serial) {
    ...
    System.out.println(miscBus.getDeviceImage());
    System.out.println(miscBus.getDeviceMode());
...
interface miscBus extends DBusInterface {
  ...
  public void setDeviceMode(byte mode_id, byte param);
